...
subscription = {
	...
	'AutoCAD series products certificated hardware list downloading': [
		"download.autodesk.com"
	],
	'ReCap sign in.': [
		"akamaiedge.net"
	],
	'No longer used from AdSSO 11.0.0.1800': [
		"s3.amazonaws.com"
	]
}
...
identity = {
	'Web Analytics': [
		...
		"duosecurity.com",
		"us.azureauth.duosecurity.com",
		"api-0897e83e.duosecurity.com",
		"oktacdn.com",
		"live.com",
		"login.live.com",
		"msftauth.net",
